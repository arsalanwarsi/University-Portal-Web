...
<body>
    ...
    $sql = "SELECT * FROM Students WHERE Student_ID = '".$_SESSION['username']."'";
    $sql_cgpa = "SELECT AVG(CGP) AS CGPA FROM SemesterGPA WHERE Student_ID = '".$_SESSION['username']."'";
    $result = sqlsrv_query($con,$sql);
    $data = sqlsrv_fetch_array($result);
    $result1 = sqlsrv_query($con,$sql_cgpa);
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <h1 class="main-heading">STUDENT INFORMATION</h1>
                        <table class="s-course">
                            ...
                            <tr>
                                <th>GCPA</th>
                                <td><?php echo(round($data1['CGPA'], 2))?></td>
                            </tr>
                        </table>
                    </div>
                </div>
